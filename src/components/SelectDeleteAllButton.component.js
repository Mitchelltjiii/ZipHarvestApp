...
class SelectDeleteAllButton extends Component{
    ...
    render() {  
        ...
        return <div>
            {checked ? <Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick}  style={{height: "20px", width: "20px", backgroundColor: "#A9A9A9"}} color={this.state.bgColors.Blue}>X</Button>
            :<Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick} style={{height: "20px", width: "20px"}}></Button>
            }
                </div>
      }
}
