...
class SelectDeleteAllButton extends Component{
    ...
    render() {  
        ...
        return <div>
            {checked ? <Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick}  style="height: 120px;width: 120px" color={this.state.bgColors.Blue}>X</Button>
            :<Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick} style="height: 120px;width: 120px"></Button>
            }
                </div>
      }
}
