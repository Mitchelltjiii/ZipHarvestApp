...
class SelectDeletePlantButton extends Component{
    ...
    render() {  
        ...
        return <div>
            {checked ? <Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick}  style={{height: "40px", width: "40px", backgroundColor: "#A9A9A9"}} >X</Button>
            :<Button aria-controls="simple-menu" aria-haspopup="true" onClick={this.handleClick} style={{height: "40px", width: "40px"}}></Button>
            }
                </div>
      }
}
