		  ...
		  <div className="full tr" style={{backgroundColor:bgColors.Offwhite,marginBottom:"3px"}}>
			  <Grid
				...
				<div style={{width:"150px",height:"30px"}}>
					...
					alignItems="right"
					>
					<FormLabel id="harvest-date-label" style={{verticalAlign:"center",align:"center",marginTop:"2px",marginBottom:"2px",marginLeft:"2px",marginRight:"2px"}}><b>{harvestDateLabelText}</b></FormLabel>
