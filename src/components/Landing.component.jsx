    ...
    return(
        ...
        <div>
			{currentPage === 'harvest-form' ? (
				...
				<ManagePlantsForm getHarvestBatches={getHarvestBatches} getHarvestRecords={getHarvestRecords} getPlants={getPlants} refreshOuter={refreshOuter} userID={userID} setPlants={setPlants}/>
			) : null}
        </div>
    )
}
