...
function TutorialForm() {
    ...
    const TutorialText = () => {	  
        ...
        >
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Dry Rooms</div>
...
Click “Next Plant”.</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Voice Control</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Voice Command: “Search (plant tag)”</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Voice Command: “(weight) (unit)”</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Voice Command: “Next Plant”</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Edit Data in the App</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Export data</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Interpret and Manipulate data in Csv</div>
            ...
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize,fontWeight:"bold"}}>Upload to Metrc</div>
