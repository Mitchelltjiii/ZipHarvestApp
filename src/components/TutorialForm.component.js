   ...
   if(isMobile){
    ...
    const TutorialText = () => {	  
        ...
        >
            ...
            <div style={{textAlign:"left",marginTop:"5px",fontSize:fontSize}}>There are three simple steps: import your data, harvest, and export your data for upload to Metrc. We have provided step-by-step instructions that go into more detail.</div>
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize}}><b>Download Data from Metrc</b></div>
            <div style={{textAlign:"left",marginTop:"5px",fontSize:fontSize}}>Flowering plants from Metrc must be imported into ZipHarvest in order to harvest. Download a CSV file of the plants you’d like to select from in the flowering plants section of your Metrc account. If you open the file, the headers of the CSV file should be “Tag, Strain, Location, Hold, Group, Group Type, Group Date, Phase Date, Harvested.”</div>
            <div style={{textAlign:"left",marginTop:"20px",fontSize:fontSize}}><b>Import Data into ZipHarvest</b></div>
            <div style={{textAlign:"left",marginTop:"5px",fontSize:fontSize}}>Go to the Manage Plants section in ZipHarvest via the main menu. Click the upload button at the top of the screen and then select choose files. Select as many files as you’d like and click upload.  You should see the plants you selected appear in the table below. These plants will be available for harvest now. If you would like to remove any plants from your available list, select them and then click the delete button.</div>
            ...
            <div style={{textAlign:"left",marginTop:"5px",fontSize:fontSize}}>Harvest Batches are defined by Metrc as:
“Each harvest in Metrc is assigned to a "harvest batch," which is a single day's harvest activity. Licensees may choose whether or not to delineate harvest batches by strain or other criteria. However, harvested plants can only be grouped under the same harvest batch if they share an identical:
Name of harvest batch,
Date of harvest,
Type of harvest (manicure or "regular"),
