   ...
   let margL = "80px";
    ...
    const TutorialText = () => {	  
        ...
        >
            ...
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Data</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Download Data from Metrc</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Flowering plants from Metrc must be imported into ZipHarvest in order to harvest. Download a CSV file of the plants you’d like to select from in the flowering plants section of your Metrc account. If you open the file, the headers of the CSV file should be “Tag, Strain, Location, Hold, Group, Group Type, Group Date, Phase Date, Harvested.”</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Import Data into ZipHarvest</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Go to the Manage Plants section in ZipHarvest via the main menu. Click the upload button at the top of the screen and then select choose files. Select as many files as you’d like and click upload.  You should see the plants you selected appear in the table below. These plants will be available for harvest now. If you would like to remove any plants from your available list, select them and then click the delete button.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Dry Rooms</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Go to the Manage Dry Rooms section in ZipHarvest via the main menu. Click the Add Dry Room button at the top of the screen and then simply type the name of your first dry room exactly as it appears in Metrc. Any discrepancy will be rejected by Metrc upon upload. When you click the Add Dry Room button again it should appear in the table below. You may delete dry rooms by selecting them and clicking the Delete button. When it is time to export harvest batches to Metrc, you will choose which dry room each batch came from and the data will be applied in the exported file.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Harvesting</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Getting Started</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Select Harvest Now from the main menu. Then create your first harvest batch.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Harvest Batches</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Harvest Batches are defined by Metrc as:
“Each harvest in Metrc is assigned to a "harvest batch," which is a single day's harvest activity. Licensees may choose whether or not to delineate harvest batches by strain or other criteria. However, harvested plants can only be grouped under the same harvest batch if they share an identical:
Name of harvest batch,
Date of harvest,
Type of harvest (manicure or "regular"),
...
Rooms cannot be changed in Metrc after harvest; as long as weight is accurate and all other requirements are met (security, etc.) product may be moved to another room after harvest even if it differs from the harvest batch room.” “
            ...
            <div style={{textAlign:"center",marginTop:"5px"}}>To record your harvest weights, first select what strains you will be searching from. In the dropdown menu that says “All Strains”, you may select a strain to filter your search results or leave it be to search through all strains. Then, from the dropdown menu that has “contains” selected, select if you’d like to search for any plant tag that contains your search query or ends with it. For each plant that you harvest, you will do the following actions:
Search for your plant tag in the search field. If there are any plant tags in your imported data that contain or end with your search query, they will appear in the dropdown list that’s labeled “Search Results will appear here”. You may select your desired result from the list.
Enter the weight and unit of the selected plant in the appropriate field.
Click “Next Plant”.</div>
            ...
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Voice Control</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>The three main steps of harvesting can all be done with voice control. ZipHarvest is intended to work with voice control, but it is not required. To activate voice control, click the large button with a microphone symbol. Each command can be executed from this single button if you follow the correct procedure.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Voice Command: “Search (plant tag)”</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>If you say “Search 026”, ZipHarvest will enter “026” into the search field and results should appear.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Voice Command: “(weight) (unit)”</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>If you say “1.2 pounds”, ZipHarvest will enter “1.2” into the weight field and select “lbs” from the unit selector. Similarly, if you say “1600 grams”, ZipHarvest will enter “1600” into the weight field and select “g” from the unit selector.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Voice Command: “Next Plant”</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>If you say “Next Plant”, the Next Plant button will be selected.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}>These three types of commands are all you need to start harvesting and recording your data with only one hand required.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Edit Data in the App</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>After you have recorded a plant’s weight, you may change the weight and unit or remove it from the harvest batch in the table on the Harvest Now form. Simply click the Edit button above the table, make your changes, and then click Accept Changes or Cancel.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Export data</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Go to the Harvest Batches section in ZipHarvest via the main menu. You should see any harvest batches that you’ve created in the table. Select the export button for the appropriate harvest batch. You will be prompted to select a dry room. Finally, you will be prompted to select grams or pounds. Whatever you choose, all plants from that batch will be converted to that unit in the exported file. For example, you could have a harvest batch in which each plant is recorded in grams, but if you select pounds, all weights will be converted to pounds. If you have a mix of grams and pounds in your harvest batch and you’ve selected pounds, they will still all be converted to pounds. Once you select, your exported file should begin downloading.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Interpret and Manipulate data in Csv</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>The exported csv file will have 7 columns, [Plant Tag, Weight, Unit, Dry Room, Harvest Batch Name, X, Harvest Date]. You may make any final edits in the csv file before upload, as long as you do not affect the format.</div>
            <div style={{textAlign:"center",marginTop:"5px"}}><b>Upload to Metrc</b></div>
            <div style={{textAlign:"center",marginTop:"5px"}}>Once you have your exported file(s), you may upload them to Metrc via the Import CSV section.</div>
            </Grid>
		);
	  };
